...
arm_sqrt_f32() and arm_sqrt_q15 are functions from the DSP library that utilize the hardware FPU, and they can be found in arm_math.h.
sqrt() = software function and uses int so the FPU is definitely helping, and can be found in math.h lib.
